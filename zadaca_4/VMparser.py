    ...
    def _parseLine(self, line, n):
        ...
        if l[0] == "push":
            ...
            if l[0] == "label" and len(l) == 2:
                ...
                if l[1] in self._labele:
                    return "//" + " ".join(l) + "\n" + self._goto(l[1], n)
                else:
                    self._flag = False
                    Parser._error("Parser", n, "goto skok na nedefiniranu labelu")
                    return ""
                ...
                if l[1] in self._labele:
                    ...
                    self._flag = False
                    Parser._error("Parser", n, "if-goto skok na nedefiniranu labelu")
                    return ""
